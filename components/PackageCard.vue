  ...
  <div class="flex flex-col rounded-lg shadow bg-white dark:bg-gray-800 p-6 hover:shadow-lg dark:hover:bg-black space-y-4">
    <div class="space-y-2 flex-1">
      <div class="flex items-center justify-between">
        <NuxtLink target="_blank" class="font-semibold text-gray-800 dark:text-gray-300 flex-1" :to="repo.html_url">{{ repo.full_name }}</NuxtLink>
      ...
      <NuxtLink target="_blank" class="block text-gray-600 dark:text-gray-500 line-clamp-2" :to="repo.html_url">{{ $emoji.replace_colons(repo.description) }}</NuxtLink>
    </div>
    <div class="flex items-center gap-4 text-sm text-gray-400 dark:text-gray-500">
      <NuxtLink target="_blank" class="text-center cursor-pointer inline-flex items-center space-x-2" :to="repo.owner.html_url">
      ...
      <nuxt-link target="_blank" :to="repo.html_url" class="ml-auto">
